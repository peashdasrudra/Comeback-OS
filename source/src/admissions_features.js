...
export const ADMISSIONS_TRACKER_TEMPLATE = {
  ...
  checklist: [
    {item:"Research KUET professors & identify top 3 matches",deadline:"2026-05-12",completed:false,priority:"CRITICAL"},
    {item:"Email KUET Prof Sobhan with thesis abstract",deadline:"2026-05-17",completed:false,priority:"CRITICAL"},
    {item:"Email Prof Mamunur Rashid (evolutionary algorithms)",deadline:"2026-05-20",completed:false,priority:"HIGH"},
    {item:"Draft 1-page SOP (comeback story + research)",deadline:"2026-05-22",completed:false,priority:"CRITICAL"},
    {item:"Get supervisor rec letter draft to Mr. Riaz Mohammed",deadline:"2026-05-27",completed:false,priority:"CRITICAL"},
...
export const RESEARCH_PAPER_TRACKER = {
  ...
  milestones:[
    {phase:"Literature Review Complete",date:"2026-05-08",status:"done",note:"15+ papers reviewed"},
    {phase:"CRO Algorithm Implemented",date:"2026-05-15",status:"in_progress",note:"Binary encoding working"},
    {phase:"SHAP Analysis Complete",date:"2026-05-22",status:"pending",note:"Generating plots"},
    {phase:"Results & Comparison Table",date:"2026-06-01",status:"pending",note:"5 methods compared"},
