...
// ─── WEEKS — 5-week thesis sprint: May 11 → Jun 15, 2026 ───
const WEEKS=[
  {week:1,dates:"May 11-17",phase:1,thesis:["Explore BRCA dataset — df.info(), df.describe(), check nulls","Read supervisor Md. Riaz Mahmud's CRO papers","Attend supervisor meeting — confirm CRO variant & scope","Create GitHub repo /data /src /results /thesis — push first commit","Handle missing values per omics layer","Normalize: log2 gene expression, scale methylation 0–1"],csprep:["Arrays, Linked Lists, Stack, Queue — theory + complexity","Solve 3 easy LeetCode DSA problems"],ielts:["10 new academic words daily","1 IELTS reading passage for understanding"],admission:["Bookmark: pgadmission.buet.ac.bd, kuet.ac.bd/pgadmission","Check BUET next MSc intake date — note circular window"],blocker:"CRITICAL: Supervisor meeting THIS week. Everything flows from this.",milestone:"Supervisor aligned + GitHub live + Dataset explored + preprocessed.pkl saved"},
  {week:2,dates:"May 18-24",phase:1,thesis:["Literature review: 15 papers (5 CRO + 5 SHAP + 5 multi-omics cancer)","Understand binary CRO: molecule = 0/1 feature vector encoding","EDA: correlation heatmaps, class distribution, feature counts","Implement CRO: molecules class, energy function, decomposition reaction","Binary encoding: molecule = np.array of 0s and 1s","Test CRO on toy dataset (10 features, 50 samples)"],csprep:["Binary Trees, BST, Heap — theory + complexity","Graphs: BFS, DFS, Dijkstra — theory + code","3 tree/graph problems on LeetCode"],ielts:["10 words/day — use each in a sentence","Write 1 paragraph about your thesis in English"],admission:["Collect SSC/HSC/BSc certificates + transcripts","BUET past exam questions — list weak topics honestly"],blocker:"CRO skeleton must run without errors by end of week.",milestone:"Lit notes done + EDA plots + CRO skeleton running"},
  {week:3,dates:"May 25-31",phase:2,thesis:["Add fitness function: f(molecule) = cross-validation RF accuracy","Run CRO on full BRCA dataset","Plot convergence curve: energy vs iterations","Train RF, SVM, XGBoost on CRO-selected features","Build results table: Features | Acc | F1 | AUC","Send CRO results to supervisor for review"],csprep:["Sorting algorithms: QuickSort, MergeSort complexity","Dynamic Programming: Knapsack, LCS, Coin Change","2 DP problems"],ielts:["Task 2: 'Technology changes how people work'","Cambridge IELTS Practice Tests — start"],admission:["Compare BUET vs KUET vs KU vs DU exam formats","Decide primary target university — commit today"],blocker:"CRO on full dataset may be slow — start with 200 features max.",milestone:"CRO selects features + 3 classifiers trained + results table populated"},
  {week:4,dates:"Jun 1-7",phase:3,thesis:["Run SHAP on trained XGBoost model","Generate: shap.summary_plot, beeswarm_plot, bar_plot","Identify top 20 SHAP features — cross-reference with known BRCA biomarkers","Implement GA + PSO + LASSO + RFE baselines for comparison","Run all 5 methods on identical dataset and train/test split","Statistical tests: wilcoxon CRO vs each baseline, friedman all 5"],csprep:["OS: scheduling, deadlocks, paging","Computer Networks: OSI, TCP/IP, subnetting","Full mock exam practice — 2 hours"],ielts:["Full IELTS mock test (all 4 sections, timed)","Score yourself — identify weakest section"],admission:["Write Statement of Purpose (SOP) — 1-page draft","Request recommendation letters from 2 professors"],blocker:"SHAP top genes must match known BRCA markers. Verify in published literature.",milestone:"SHAP plots done + Statistical comparison complete + All figures finalized"},
  {week:5,dates:"Jun 8-15",phase:4,thesis:["Write Chapter 1: Introduction — problem statement, motivation, gaps","Write Chapter 2: Literature Review — from Week 2 notes","Write Chapter 3: Methodology — CRO algorithm, SHAP, dataset","Write Chapter 4: Results & Analysis — all figures and tables","Write Chapter 5: Conclusion — summary, limitations, future work","Write Abstract — 250 words: background + method + results + conclusion","Fix all references with Zotero — consistent citation style","Format: title page, TOC, figures list, page numbers — final pass","SUBMIT THESIS BY JUNE 15 🏆"],csprep:["Prepare 10 viva questions: Why CRO?, What is SHAP?, How validated?","Practice answers out loud — confident and concise"],ielts:["Register for IELTS exam — target Sep/Oct 2026","Keep 15 min daily reading as habit"],admission:["Finalize document checklist for all universities","All documents scanned as PDF and ready to upload","Email professors after submission with thesis summary"],blocker:"Write fast, revise later. A rough draft beats a perfect blank page.",milestone:"🏆 THESIS SUBMITTED. THE COMEBACK IS REAL."},
];
