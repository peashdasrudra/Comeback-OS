...
const MainLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-[#020408] text-white max-w-[430px] mx-auto relative">
      ...
      <div className="fixed top-0 max-w-[430px] w-full z-[100] bg-[#020408]/40 backdrop-blur-3xl border-b border-white/5">
      ...
      <div className="pt-24 pb-28 px-4 h-screen overflow-y-auto scrollbar-hide">
