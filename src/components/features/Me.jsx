...
const Me = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-green-900/20 via-[#020408] to-[#020408] backdrop-blur-xl border border-green-500/20 rounded-2xl p-5 shadow-xl relative overflow-hidden">
        ...
        <div className="relative border-l border-white/10 pl-6 space-y-5">
          {academicDegrees.map((d, i) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute w-2 h-2 bg-green-500 rounded-full shadow-[0_0_10px_#22c55e] -left-[25px] top-2" />
