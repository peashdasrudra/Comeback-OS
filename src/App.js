    ...
    <div style={{fontFamily:"'Rajdhani',sans-serif",background:T.bg,color:T.text,minHeight:"100vh",maxWidth:430,margin:"0 auto",position:"relative"}}>
      ...
      {levelUpAnim&&(
        ...
        {tab==="home"&&<Home {...{
          ...
          {tab==="plan"&&<Plan {...{
            activeWeek, setActiveWeek, tasksDone, setTasksDone, taskNotes, setTaskNotes, openNote, setOpenNote,
            T, orb, mono, raj, C, WEEKS, pc, weekPct, Ring
          }} />}
          {tab==="body"&&<Body {...{
            workoutDay, setWorkoutDay, dayPct, exPct, isSetDone, setTasksDone, setShowExForm, showExForm,
